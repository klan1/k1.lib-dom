...
class top_bar extends tag {
    ...
    function __construct(tag $parent, $id = "") {
        ...
        $li = $this->menu_right->append_li()->append_child(new button("Ingresar", "button", "btn-login"));
        $li = $this->menu_right->append_li()->append_child(new button("Salir", "button alert", "btn-logout"));
    }
